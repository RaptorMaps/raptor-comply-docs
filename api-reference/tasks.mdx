...
* **Handle staff transitions cleanly.** When a compliance manager leaves, call `POST /tasks/reassign-from-csm` once to transfer all open tasks to their replacement, with no hunting through individual records.
