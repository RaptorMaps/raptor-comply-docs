...
<ResponseField name="organization_slug" type="string">
  The slug of the organization that owns this facility. Matches the value you pass in the `Organization` header.
</ResponseField>
...
<ResponseField name="organization_slug" type="string">
  The slug of the organization that owns this facility.
</ResponseField>
