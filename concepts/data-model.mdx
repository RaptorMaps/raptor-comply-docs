...
A Facility represents a physical or logical NERC-registered site: a substation, generation plant, transmission station, or similar entity. Facilities are the top-level entity in most Raptor Comply workflows. Nearly everything else can be anchored to a facility: cyber systems, cyber assets, evidence, tasks, and training assignments. When you query the API, filtering by facility is usually the most direct path to the data you need.
