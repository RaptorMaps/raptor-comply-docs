---
title: "Raptor Comply API: OT Compliance for NERC entities"
...
<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/authentication">
    Set up your API key and organization slug, understand error responses, and learn key rotation best practices.
  </Card>
...
All requests go to the base URL `https://api.raptormaps.com` and require the `X-API-Key` and `Organization` headers on every call. See [Authentication](/authentication) for details.
