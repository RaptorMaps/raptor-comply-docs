---
title: "Raptor Comply API Authentication: Keys"
description: "Every Raptor Comply API request requires an X-API-Key header. Learn how to obtain, use, and rotate your API key."
---
