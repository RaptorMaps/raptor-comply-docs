---
title: "Sync Your CMDB with Raptor Comply Cyber Assets API"
...
`GET /cyber-assets` returns the complete list of cyber assets in your organization. Include the `X-API-Key` header on every request.
